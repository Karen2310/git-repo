/********
 *VARIABLES
 * var SE UTILIZAN EN CUALQUIER PUNTO DEL PROGRAMA Y SE USAN AUN SIN ANTES SER DEFINIDAS
 * let y CONST
 */
...
//let es variable, tienen definicion de bloque
if(true) {
    let y="verdadero";
}
//console.log(y);
...
const tres = "igual";
//tres= "desigual"; no funciona porque es variable constante y ya tenia valor.
...
//OPERADORES DE IGUAL
//Doble igual - Devuelve verdadero si los operadores son iguales.
//"3" == 3
